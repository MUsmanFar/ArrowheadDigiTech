...
export default function ServicesHero() {
  ...
  return (
    <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-white" aria-label="Services Hero">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-32 mt-16">
        {hero.badge && (
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.25, 0.1, 0, 1] }}>

...
export default function CtaPremium() {
  ...
  return (
    <section className="relative py-28 md:py-40 bg-[#fafafa] overflow-hidden" aria-label="Call to action">
        ...
        >
          ...
          <div className="relative px-8 py-16 md:px-16 md:py-24 text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link
                href={cta.buttonHref}
                className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-white text-orange-600 font-montserrat font-bold text-sm shadow-xl hover:bg-orange-50 transition-colors"
              >
                {cta.buttonLabel}
                <ArrowUpRight size={18} />
              </Link>
              <MagneticButton href="/portfolio" variant="secondary" className="!bg-white/10 !text-white !border-white/30 hover:!bg-white/20">
                {portfolioLabel}
                <ArrowUpRight size={18} />
              </MagneticButton>
            </div>
